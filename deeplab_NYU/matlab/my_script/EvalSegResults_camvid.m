...
if is_server
  if strcmp(dataset, 'CamVid')
    VOC_root_folder = '/home/carolina/projects/MESMERISE/caffe-segnet-segnet-cleaned/examples/SegNet-Tutorial-master/CamVid';
...
%output_mat_folder = fullfile('/home/carolina/projects/MESMERISE/DeepLab/deeplab-caffe', dataset, feature_name, model_name, testset, feature_type);
output_mat_folder = '/home/carolina/projects/MESMERISE/DeepLab/deeplab-caffe/CamVid/features/vgg128_noup/val/crf'
save_root_folder = fullfile('/home/carolina/projects/MESMERISE/DeepLab/deeplab-caffe', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder);
