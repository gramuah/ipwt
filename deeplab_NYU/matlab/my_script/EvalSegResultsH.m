...
VOC_root_folder = '/home/carlosh/workspace/DL-CARLOS/PASCAL-Context';
...
save_root_folder = fullfile('/home/carlosh/workspace/DL-CARLOS/deeplab-Carlos/', dataset, feature_name, model_name, testset, feature_type, post_folder);

fprintf(1, 'Saving to %s\n', save_root_folder);

if strcmp(dataset, 'voc12')
  year_path = strcat('/results/', '2012', '/');
  seg_res_dir = [save_root_folder year_path];
  seg_root = fullfile(VOC_root_folder, '');
  gt_dir   = fullfile(VOC_root_folder, 'SegmentationClassAug');
